 ...
 *
 * usage: KmeansPlusPlus [input image] [output image] [ncluster] [maxiter]
 ************************************************************/


#ifndef L0smoothingCpp_KMeanspp_h
#define L0smoothingCpp_KMeanspp_h
...
void KmeansPlusPlus(string filename, int _ncluster, int _maxiter)
{
