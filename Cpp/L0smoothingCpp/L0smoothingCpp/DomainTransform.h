...
void DomainTransform(string filename)
{
    cv::Mat img = cv::imread("/Users/dawang/Documents/Projects/L0smoothingCpp/image/"+ filename, CV_LOAD_IMAGE_COLOR);
    ...
    cv::imwrite("/Users/dawang/Documents/Projects/L0smoothingCpp/image/2a.jpg", out);
}
