...
+ Data Files
    ...
    + Toyota.txt: The description of the Toyota car
    + input_format.txt: The input format of the data
    + auto.ser: The serialized data for test
    + exception_log.txt: log file for exceptions
    + default_car_model.txt: the default car model file
+ Readme
