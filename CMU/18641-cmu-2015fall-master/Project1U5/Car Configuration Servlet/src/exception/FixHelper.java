...
public class FixHelper {
	...
	public void fixFileNotFound(LinkedHashMap<String, Automobile> automobileList){
	...
	// input fleet
	public void fixSerialCarFileNotFound(LinkedHashMap<String, Automobile> automobileList){
		Automobile auto = null;
		try {
